...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('R6bvevyu4C', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-wEsBa0aa3', 0, 'RtmY9AqwiMhyKQ3ZApvBg-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'kaduna_polytechnic', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4fe305b4ab8d0346d8eab2a1fad8106c5d5a5fda269ff41245109af64f2ce5f0');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('fyvKDCQHh3', NULL, 'RtmY9AqwiMhyKQ3ZApvBg-', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/activate');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/viewapplications');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/fullInfo');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/continue');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/printSlip');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/printSlip2');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/edit');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/printSlip3');

        $q = new \Symfony\Component\Security\Http\AccessMap();
        $q->add($h, array(0 => 'ROLE_ADMIN'), NULL);
        $q->add($i, array(0 => 'ROLE_ADMIN'), NULL);
        $q->add($j, array(0 => 'ROLE_ADMIN'), NULL);
        $q->add($k, array(0 => 'ROLE_ADMIN'), NULL);
        $q->add($l, array(0 => 'ROLE_STUDENT_APP'), NULL);
        $q->add($m, array(0 => 'ROLE_STUDENT_APP'), NULL);
        $q->add($n, array(0 => 'ROLE_STUDENT_APP'), NULL);
        $q->add($o, array(0 => 'ROLE_STUDENT_APP'), NULL);
        $q->add($p, array(0 => 'ROLE_STUDENT_APP'), NULL);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($q, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.our_db_provider']) ? $this->services['security.user.provider.concrete.our_db_provider'] : $this->getSecurity_User_Provider_Concrete_OurDbProviderService()) && false ?: '_'}), 'main', $a, $c, $d), 2 => $s, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $r, 'main', $t, $u, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '593a8d62dabc58.42779960', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['security.access.decision_manager']) ? $this->services['security.access.decision_manager'] : $this->getSecurity_Access_DecisionManagerService()) && false ?: '_'}, $q, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $r, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $r, 'login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.our_db_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('nuhurainmaker@gmail.com');
        $a->setPassword('NABIHANUHU');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('03263ed0fe6e765ed2d3d6072513d633425c20c4');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B8uJ-ELZEr', 0, 'RtmY9AqwiMhyKQ3ZApvBg-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Fly8ugzVSN', 0, 'RtmY9AqwiMhyKQ3ZApvBg-', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'kaduna_polytechnic',
            'database_user' => 'root',
            ...
            'secret' => '03263ed0fe6e765ed2d3d6072513d633425c20c4',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '03263ed0fe6e765ed2d3d6072513d633425c20c4',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'nuhurainmaker@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'NABIHANUHU',
